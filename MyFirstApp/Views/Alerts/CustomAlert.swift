...
//  MyFirstApp
//
//  Created by Pavel Andreev on 1/31/22.
//
...
class CustomAlert {
    ...
    func alertCustom(viewController: UIViewController, repsOrTimer: String ,competetion: @escaping(String, String) -> Void) {
        ...
        sportsWoman.image = UIImage(named: "sportsWomanAlert")
        sportsWoman.contentMode = .scaleAspectFit
        alertView.addSubview(sportsWoman)
        ...
        let setsLabel = UILabel(font14: "Sets")
        ...
        //MARK: - ТИП КЛАВИАТУРЫ ТОЛЬКО ЧИСЛА!!!!
        setsTextField.keyboardType = .numberPad
        alertView.addSubview(setsTextField)
        
        let repsOrTimerLabel = UILabel(font14: "\(repsOrTimer)")
